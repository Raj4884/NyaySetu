...
class NLPService:
    ...
    def _get_embedder(self):
        if self.embedder is None:
            try:
                ...
                print(f"Embedding Model Initialization Error: {e}")
    ...
    def _get_summarizer(self):
        if self.summarizer is None:
            try:
                ...
                print(f"Summarization Model Initialization Error: {e}")
    ...
    def get_embeddings(self, text):
        ...
        outputs = embedder(truncated_text)
    ...
    def generate_summaries(self, text, context=None):
        ...
        try:
            ...
            base_summary = summarizer(statute_prompt, max_length=150, min_length=40, do_sample=False)[0]['summary_text']
